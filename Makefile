all:	tools/tobin tools/dmp2bin bootmenu.bin bdvtest.bin
...
bootmenu.bin:	bootmenu.mac Makefile
	...
	./tools/gendump.sh bootmenu.bin > bootmenu.dmp
...
tools/dmp2bin:	tools/dmp2bin.c
	gcc -o tools/dmp2bin tools/dmp2bin.c
